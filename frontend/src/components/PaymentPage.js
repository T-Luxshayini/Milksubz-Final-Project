...
function PaymentPage() {
  ...
  const handleOrderSubmit = async () => {
    ...
    try {
      ...
      // Redirect to Stripe Checkout page with clientSecret
      window.location.href = `http://localhost:5005/api/stripe/stripe-checkout/${clientSecret}`;
    } catch (error) {
    ...
    >
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          ...
          <Typography variant="h6" gutterBottom align="center" color="#41B3A2" fontWeight="bold">
            Total Price: $ {totalAmount}
          </Typography>
          <TextField
            label="Name"
